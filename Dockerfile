...
RUN sed -i '/deb-src/d' /etc/apt/sources.list && \
    ...
    apt-get install -y libffi-dev build-essential chrpath libssl-dev libxft-dev  # Needed for PhantomJS && \
    apt-get install -y libffi-dev libfreetype6 libfreetype6-dev libfontconfig1 libfontconfig1-dev # Needed for PhantomJS
